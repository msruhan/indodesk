...
export const createImeiOrderBodySchema = z.object({
...
/** @deprecated Use createImeiOrderBodySchema + validateImeiOrderDeviceInput per service flags */
export const createImeiOrderSchema = createImeiOrderBodySchema
...
export type CreateImeiOrderInput = z.infer<typeof createImeiOrderBodySchema>
