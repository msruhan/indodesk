...
/** POST /api/admin/telegram/account/sync */
export async function POST(req: Request) {
  ...
  try {
    ...
    return apiSuccess({
      ...
      message:
        result.error ??
        'Belum terdeteksi di Telegram. Pastikan Anda membuka link dari dashboard dan menekan Start.',
    })
  } catch (e) {
    console.error('[ADMIN_TELEGRAM_SYNC_ERROR]', e)
