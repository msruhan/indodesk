...
import { Plus, CreditCard, TrendingUp, X } from '@/lib/icons'
...
export function UserSaldoView() {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Wallet Card */}
      <Card className="border-primary-200/50 bg-gradient-to-br from-primary-50 to-primary-50/50">
        <CardContent className="p-6">
          <div className="flex items-start justify-between">
            <div>
              <p className="text-sm font-medium text-primary-700">Saldo Anda</p>
              <p className="mt-2 text-3xl font-bold text-primary-900">{formattedBalance}</p>
              <p className="mt-1 text-xs text-primary-600">
                Terakhir update: {wallet ? new Date(wallet.updatedAt).toLocaleDateString('id-ID') : '-'}
              </p>
            </div>
            <div className="flex h-12 w-12 items-center justify-center rounded-xl bg-primary-200/50">
